...
angular.module('ngScrollTo')
  ...
  .service('ScrollTo', ['$window', 'ngScrollToOptions', function($window, ngScrollToOptions) {
    ...
    this.idOrName = function (idOrName, offset, focus) {//find element with the given id or name and scroll to the first element it finds
        ...
        $("li, li a").removeClass("ecl-navigation-inpage__link--is-active");
        $("li a.ecl-navigation-inpage__link[scroll-to='"+idOrName+"']").addClass("ecl-navigation-inpage__link--is-active");
        $("li a.ecl-navigation-inpage__link[scroll-to='"+idOrName+"']").parent().addClass("ecl-navigation-inpage__link--is-active");
